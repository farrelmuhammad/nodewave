...
const Hero = () => {
  return (
    <main className="flex h-full items-center justify-between p-24">
      <div
        className="absolute inset-0 bg-cover bg-center w-[1512px] h-[881px] top-[-89px] left-[312px] bg-opacity-50 bg-black"
        style={{
          backgroundImage: 'url("/path/to/your/background-image.jpg")', // Ganti dengan path gambar latar belakang Anda
        }}
      ></div>
