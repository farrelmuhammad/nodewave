const Hero = () => {
  return (
    <section className="relative flex container mx-auto max-w-screen py-8 md:py-16 h-screen items-center justify-between">
      <div
        className="absolute inset-0 bg-cover bg-center max-w-screen h-auto top-[-89px] left-[412px] bg-opacity-50 bg-black"
        style={{
          backgroundImage: 'url("/assets/background.png")',
        }}
      ></div>

      <div className="relative z-10 flex justify-center h-full items-start flex-col">
        <h1 className="mb-2 text-3xl font-medium text-white md:mb-4 lg:text-5xl">
