    ...
    <header class="absolute w-full z-50 px-4">
      <div class="container mx-auto py-5">
        <div class="flex flex-stretch items-center">
          ...
          <div class="w-auto">
            <ul
              class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible  md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
              id="menu"
            >
