        ...
        <div className="col-span-12 md:col-span-5">
          <div className="space-y-2 md:space-y-4 flex flex-col items-center">
            <button
              ...
              className="rounded-xl hover:px-4 hover:md:px-8 hover:py-6 hover:md:py-12 hover:w-full hover:bg-white hover:border hover:border-[#298EF6] px-4 md:px-8 py-6 md:py-12 w-full bg-[#E8F4FF] border border-[#298EF6]"
            >
