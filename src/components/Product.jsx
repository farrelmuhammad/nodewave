        ...
        <div className="col-span-12 md:col-span-7">
          <div style={{ opacity: 1 }}>
            ...
            >
              ...
              <h2 className="text-lg text-center font-app font-medium text-black lg:text-2xl">
                Mobile Apps
              </h2>
              <p className="text-xs mt-2 mb-4 text-center font-normal text-[#333333] lg:text-sm">
